...
class AiInsightsController
{
    ...
    public function index(Request $request, Response $response): Response
    {
        ...
        try {
            ...
            return $this->view->render($response, 'admin/ai_insights/index.twig', [
                ...
                'meters' => [],
                'recent_insights' => [],
                'error' => 'An error occurred loading AI insights. Please check the logs.'
            ]);
        }
    }
    ...
    public function viewMeter(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            ...
            error_log('AI Insights meter view error: ' . $e->getMessage());
            $_SESSION['flash'] = [
                'type' => 'error',
                'message' => 'An error occurred loading meter insights'
            ];
            return $response
                ->withHeader('Location', '/admin/ai-insights')
                ->withStatus(302);
    ...
    public function settings(Request $request, Response $response): Response
    {
        try {
            ...
            error_log('AI Insights settings error: ' . $e->getMessage());
            $_SESSION['flash'] = [
                'type' => 'error',
